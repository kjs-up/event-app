...
exports.InitialSetup1701436800000 = void 0;
const typeorm_1 = require("typeorm");
class InitialSetup1701436800000 {
    ...
    async up(queryRunner) {
        ...
        `);
        await queryRunner.createForeignKey("event_projects", new typeorm_1.ForeignKey({
        ...
        await queryRunner.createIndex("users", new typeorm_1.Index({
        ...
        await queryRunner.createIndex("event_projects", new typeorm_1.Index({
...
exports.InitialSetup1701436800000 = InitialSetup1701436800000;
//# sourceMappingURL=1701436800000-InitialSetup.js.map